...
describe('AnswerController', () => {
  ...
  describe('submit()', () => {
    ...
    it(`should return object instance of ${SuccessfulResponse.name} when user_id is present`, async () => {
      ...
      expect(
        learningRecommendations.every(
          (recommendation) => recommendation instanceof LearningRecommendation,
        ),
      ).toBeTruthy();
    });
    it(`should return object instance of ${SuccessfulResponse.name} when user_id is missing`, async () => {
